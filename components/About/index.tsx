...
const people: PersonType[] = [
...

  {
    ...
    description: `Dave is a technology veteran bringing over 2 decades of experience in Engineering, Product, Analytics, Infrastructure and Cyber Security. Most recently, he built the technology powering Finitive, the institutional investment platform for private credit handling billions in transactions, and scaled their engineering organization in 4 different continents. Prior to that, Kiran spent over 15 years at a Morgan Stanley-backed global trading organization overseeing platforms and systems for freight trading, ERP, business intelligence, analytics, and risk management. Kiran holds an Engineering degree from Bangalore University.`,
  },
];
const About = () => {
